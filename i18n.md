...
This trait will allow not only the usage of the `i18nMessage` method but will additionally index every string declared in default property value and embraced with `[[` and `]]`.
