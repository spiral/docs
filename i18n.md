...
For example, English has only two forms, while Russian has three. You can find language formulas for different languages [here] (http://localization-guide.readthedocs.org/en/latest/l10n/pluralforms.html).
