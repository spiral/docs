# Query Builders
You can read how to work with Database using manually written queries [here](/v1.0.0/databasebase/pdo.md). 
...
> You can read more about declarative schemas [here](/v1.0.0/databasebase/declaration.md).
...
In addition, SelectQuery support [Pagination](/v1.0.0/components/pagination.md) component and makes you able to manipulate with results easier:
