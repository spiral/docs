# Request and Input
As mentioned in [Http Flow](/v1.0.0/httphttp/flow.md) you can access incoming request in your controllers and services using "request" binding, or via `ServerRequestInterface` dependency. Such instance is only available inside `HttpDispatcher` perform method.
