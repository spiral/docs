...
> Technically Spiral ORM is a hybrid between DataMapper and ActiveRecord, in a short plans to keep same functionality but make it more universal and give ability to create your own entity models based on interface rather that parent Record class.
