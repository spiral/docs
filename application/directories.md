...
> Spiral Framework bundle does not force any of default application namespace or strict structure except for http routing (see AppBootloader to change that), be free to add more models or classes when you need them (for example ViewModels/Presenters).
