...
In addition to generic service functionality spiral provides ability to create set of methods specific to some data entity (repository), this can be done by providing `-e` flag
