# Making Modules
Spiral framework makes it easy to split your application code to external package. Spiral use Composer to load your classes, so you only need to define proper [Bootloader](/old/frameworkwork/bootloaders.md) in your module to bind your implementations. 
...
> Attention, **do not** alter configs using absolute paths, only use directory based [aliases](/old/application/directories.md) if you want your module work in any environment.
