# Query Builders
You can read how to work with Database using manually written queries [here](/old/databasebase/pdo.md). 
...
> You can read more about declarative schemas [here](/old/databasebase/declaration.md).
...
In addition, SelectQuery support [Pagination](/old/components/pagination.md) component and makes you able to manipulate with results easier:
