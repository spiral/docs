...
> Install [scaffolder module](/old/modulesules/scaffolder.md) first.
...
All migration methods are based on DBAL functions, feel free to use same abstract types as in [direct schema declarations](/old/databasebase/declaration.md).
