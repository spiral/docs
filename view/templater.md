...
> Attention, default value for blocks like `${name|default}` is always simple string which will be trimmed. If you want to define more complex default value, or keep spaces use inner language to define block: `${name | <?=" " . "abc"?>}`.
