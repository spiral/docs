...
## Connect locales
The simpliest way to connect new locale to your application is to put localization files into app/resources/locales/{language-code} directory.

For example file "app/resources/locales/ru/views.ru.po" will represent "views" bundle for russian language.

> See below what i18n data formats are supported.
