...
Also you can find set of classes and interfaces used to describe and declare desired table schema, check schema [reading] (readers.md) and writing (syncing.md) classes.
