...
Spiral Database layer provides ability to read and analyzie basic properties of given database or given table. In addition to that, DBAL contain mechanism used to convert set of column typess specific to some DBMS into limited set of "abstract" types available for user.
